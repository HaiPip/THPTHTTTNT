...
with open('movie_data.json', 'r+', encoding='utf-8') as f: #update movie data path
    data = json.load(f)
with open('movie_titles.json', 'r+', encoding='utf-8') as f: #update movie title path
...
def run():
    img1 = Image.open('logo.jpg') #update this path 
